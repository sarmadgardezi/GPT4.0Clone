...
export default function ChatInput({}: Props) {
  ...
  return ( 
    <div className="fixed bg-dk bottom-0 flex h-40 w-full bg-gradient-to-t from-[rgb(var(--bg-secondary))] to-transparent md:w-[calc(100%-260px)]">
      <form
      ...
      >
        <div className="relative flex w-full flex-row rounded border border-stone-500/20 bg-tertiary shadow-xl">
          <textarea
            ref={textAreaRef}
            className="max-h-[200px] w-full resize-none border-none bg-tertiary p-4 text-primary outline-none bg-custom-gradient"
          ...
          <button
            type="submit"
            className="rounded p-4 text-primary hover:bg-primary/50 bg-custom-gradient"
          >
            {loading ? (
